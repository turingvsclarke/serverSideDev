...
<?php
            ...
            $message = $fn." ".$ln.", \n We recently received a request for a new user using this email address. Please use the following link for account activation:http://corsair.cs.iupui.edu:24331/lab3/lab3registered.php?a=".$code;
